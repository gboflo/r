...
IS_VELOCITY_MODE=((model.isVelocityMode??) && model.isVelocityMode?has_content && model.isVelocityMode == true)?then(true, false)
...
<#--Execution report general information labels-->
GENERAL_HEADER="General Information"
HEADLINE="Headline"
OWNER="Owner"
...
STEP_HEADER="Steps"
STEP_COLUMN_NAMES=IS_VELOCITY_MODE?then(["Step #", "Action", "Start Time", "Duration"], ["Step #", "Action", "Documentation", "Start Time", "Duration"])
STEP_ACTION="Action:"
...
STEP_DOCUMENTATION_COMMENT="Comment:"
STEP_DOCUMENTATION_LABEL="Label:"
STEP_DOCUMENTATION_TAG="Tag:"
>
...
<#macro renderLink description="" link="">
	...
	<tr class="b-table-form-row">
		<th class="b-table-form__cell b-table-form__cell_label">
			<div class="b-table-form-cell b-table-form-cell_label">
				<div class="b-table-form-cell__label">
					<div class="b-label b-label_form">
...
<#macro renderParameters>
	...
	<@renderTableFrame title=PARAMETERS_HEADER colNames=PARAMETER_COLUMN_NAMES colGroups=["g-col-index", "g-col-name", "g-col-type", "g-col-parameter-file-value"]>
		...
		<tr class="b-table-row b-table-row_colored">
			...
			<td class="b-table__cell">
				<div class="b-table-cell">
					<div class="b-table-cell__item">
						<div class="b-text">${parameter.type}</div>
					</div>
				</div>
			</td>
			<td class="b-table__cell">
				<#if parameter.value?has_content>
					<div class="b-table-cell">
						<div class="b-table-cell__item">
							<#if (parameter.masked?has_content && parameter.masked) || (parameter.type?has_content && "Secret" == parameter.type)>
...
<#macro renderExtractedData>
	...
	<@renderTableFrame title=EXTRACTEDDATA_HEADER colNames=EXTRACTEDDATA_COLUMN_NAMES
		colGroups=["g-col-label", "g-col-label"]>
        <#list model.report.extractedData as extract>
            <tr class="b-table-row b-table-row_colored">
                <td class="b-table__cell">
                    <div class="b-table-cell">
                        <div class="b-table-cell__item">
                            <a class="b-text" name="${extract.tag}" id="${extract.tag}">
                                <span class="b-text">${extract.tag}</span>
                            </a>
                        </div>
                    </div>
                </td>
                <td class="b-table__cell">
					<#if extract.data?has_content>
						<div class="b-table-cell">
							<#list extract.data as item>
								<div class="b-table-cell__item">
...
<#macro renderStepsTable>
	...
	<#assign listColumns=IS_VELOCITY_MODE?then(
			["g-col-index", "g-col-step-action", "g-col-step-start-time", "g-col-step-duration"],
			["g-col-index", "g-col-step-action", "g-col-step-docs", "g-col-step-start-time", "g-col-step-duration"])
	/>
	<@renderTableFrame title=STEP_HEADER colNames=STEP_COLUMN_NAMES colGroups=listColumns>
			...
			<tr class="b-table-row b-table-row_big" style="${background}">
				...
				<td class="b-table__cell">
					<div class="b-table-cell">
						...
						<#if step.session?has_content>
							<div class="b-table-cell__item">
								<div class="b-flex-row">
									<div class="b-flex-row__item">
										<div class="b-label">${STEP_SESSION}</div>
									</div>
									<div class="b-flex-row__item">
										<div class="b-text b-text_description b-text_multiline">${step.session}</div>
									</div>
								</div>
							</div>
						</#if>						
					...
					<td class="b-table__cell">
						<div class="b-table-cell">
							<div class="b-table-cell__item">
								<div class="b-flex-row">
									<div class="b-flex-row__item">
										<div class="b-label">${STEP_DOCUMENTATION_LABEL}</div>
									</div>
									<div class="b-flex-row__item">
										<div class="b-text b-text_description b-text_multiline">${step.documentationLabel}</div>
									</div>
								</div>
							</div>
							<div class="b-table-cell__item">
								<div class="b-flex-row">
									<div class="b-flex-row__item">
										<div class="b-label">${STEP_DOCUMENTATION_TAG}</div>
									</div>
									<div class="b-flex-row__item">
										<div class="b-text b-text_description b-text_multiline">${step.documentationTag}</div>
									</div>
								</div>
							</div>
							<div class="b-table-cell__item">
								<div class="b-flex-row">
									<div class="b-flex-row__item">
										<div class="b-label">${STEP_DOCUMENTATION_COMMENT}</div>
									</div>
									<div class="b-flex-row__item">
										<div class="b-text b-text_description b-text_multiline">${step.documentationComment}</div>
									</div>
								</div>
							</div>
						</div>
...
<#macro renderReportGeneral>
	<#if !VISIBILITY_OF_REPORT_SECTIONS.general>
		<#return>
	</#if>
	<#if model.report.headline?has_content || model.report.owner?has_content || model.report.description?has_content || model.report.tags?has_content || model.report.testCaseId?has_content || model.report.testCaseName?has_content || model.report.namespace?has_content>	
		<@card headerTitle=GENERAL_HEADER>
			<@renderFormRow label=HEADLINE field=model.report.headline/>
			<@renderFormRow label=OWNER field=model.report.owner/>
			<@renderFormRow label=DESCRIPTION field=model.report.description/>
			<@renderFormRow label=TAGS field=model.report.tags/>
			<@renderFormRow label=TEST_CASE_ID field=model.report.testCaseId/>
			<@renderFormRow label=TEST_CASE_NAME field=model.report.testCaseName/>
			<@renderFormRow label=NAMESPACE field=model.report.namespace/>
		</@card>
	</#if>
</#macro>
...
<#macro renderArtifacts>
	<#if !VISIBILITY_OF_REPORT_SECTIONS.artifacts>
		<#return>
	</#if>
	<#if !IS_VELOCITY_MODE>
		<@card headerTitle=ARTIFACTS_HEADER>
			<#list model.steps as step>
				<#list step.artifactLinks as artifactLink>
					<@renderLink link=artifactLink.link description=artifactLink.description/>
				</#list>
			</#list>
		</@card>
	<#else>
		<#assign showEmptyCard=model.stepsArtifactLinks?? && model.stepsArtifactLinks?has_content />
		<#if !showEmptyCard>
			<#return>	
		</#if>
		<#assign firstLink=""/>
		<#assign firstDescription=""/>
		<#list model.stepsArtifactLinks as artifactLink>
			<#if artifactLink?has_content && artifactLink.artifactLink?has_content>
				<#assign firstLink=artifactLink.artifactLink["link"]/>
				<#assign firstDescription=artifactLink.artifactLink["description"]/>
			</#if>
			<#break>
		</#list>		
		<#if !(firstDescription??) || !(firstDescription?has_content) || !(firstLink??) || !(firstLink?has_content)>
			<#return>
		</#if>
		<@card headerTitle=ARTIFACTS_HEADER>
			<@renderLink link=firstLink description=firstDescription/>
			<#list model.stepsArtifactLinks as artifactLink>
				<#if artifactLink?has_content && artifactLink.artifactLink?has_content>
					<#assign link=artifactLink.artifactLink["link"]/>
					<#assign description=artifactLink.artifactLink["description"]/>
					<@renderLink link=link description=description/>
				</#if>
			</#list>
		</@card>
	</#if>
...
<#macro renderTopologyPreview>
	<#assign isVelocityTopology=model.velocityBaseUrl?has_content && model.report.topologyId?has_content>
